    ...
    return (
        <div className=" poppins " >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-2  px-6 sm:px-8 lg:px-52 pb-10">
                {/* Card 1 */}
                <div className="shadow-md overflow-hidden bg-black">
                    ...
                    <motion.div
                     ...
                     className="relative">
                        <img
                            src={assets.aboutimg}
                            alt="About Us"
                            className="w-full h-64 sm:h-80 md:h-[420px] object-cover shadow-[#a01d23] shadow-lg duration-200 ease-in-out "
                        />
                        {/* Button o */}
                        <button className="absolute bottom-0 left-0 w-full bg-black text-white py-2 hover:text-[#a01d23] transition">
                            View Details →
                        </button>
                    </motion.div>
                    ...
                    <motion.div
                     ...
                     viewport={{ once: true, amount: 0.5 }}
                     transition={{ duration: 0.9 }}
                     className="p-4 pt-3 pb-6 text-left text-white">
                ...
                <div className="shadow-md overflow-hidden bg-black">
                    ...
                    <motion.div
                     ...
                     viewport={{ once: true, amount: 0.5 }}
                     transition={{ duration: 0.9 }}
                     className="p-4 pt-3 pb-6 text-white text-left">
                        <h3 className="text-lg font-semibold">Real Estate Projects</h3>
                        <p className="">Dream Land</p>
                        <p className="text-sm mt-2">Red Sandalwood</p>
                        <p className="text-sm">Open Lands</p>
